package pers.lyrichu.jml.nlp.text_generation.eng_text;
...
import pers.lyrichu.jml.nlp.text_generation.util.CharacterIterator;
...
public class LSTMCharModellingExample {
    ...
    public static CharacterIterator getShakespeareIterator(int miniBatchSize, int sequenceLength) throws Exception {
        ...
        String fileLocation = "jml/resources/Shakespeare.txt";	//Storage location from downloaded file
